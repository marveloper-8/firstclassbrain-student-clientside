    ...
    return (
        <div className="classroom">
            ...
            <div className="subjects-container">
                <div>
                    <Link className="link" to={'/weeks/' + classSelected + '/' + subject + '/' + 1}>
                ...
                <div>
                    <Link className="link" to={'/weeks/' + classSelected + '/' + subject + '/' + 2}>
                    <div className="subjects">
                        <div className="image">
                            <img src={goal} alt="Mathematics" />
                        </div>
                ...
                <div>
                    <Link className="link" to={'/weeks/' + classSelected + '/' + subject + '/' + 3}>
                    <div className="subjects">
                        <div className="image">
                            <img src={goal} alt="Mathematics" />
                        </div>
