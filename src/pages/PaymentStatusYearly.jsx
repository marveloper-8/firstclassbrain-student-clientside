...
function PaymentStatusYearly() {
    ...
    const PostPayment = (paymentToken) => {
        fetch(`https://firstclassbrain-server.herokuapp.com/verify/payment/annually/${paymentToken}`, {
            method: "post",
            headers: {
    ...
    return (
        <div className="classroom" onLoad={PostPayment(payment_token)}>
            ...
            <div className="payment-status">
                ...
                {studentState ? studentState.firstName: "loading"}, you have successfully subscribed to the Platinum (One Year) subscription plan! Logout and log back in to access the First Class Brain Classroom!
            </div>
