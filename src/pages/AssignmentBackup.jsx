                                ...
                                testDetails.test.questions.map((questionsItem, idx) => {
                                    ...
                                    return(
                                        <div className="item" key={idx}>
                                            <div key={idx}>{answerSelected}</div>
                                            {
                                                answerSelected == questionsItem.correctAnswer
                                                ?
                                                testIncrease
                                                :
                                                ""
                                            ...
                                            <div className="answer-options">
                                                <div className="tab">
                                                    <div className="select" onClick={testHello}>
                                                        <input 
                                                            type="radio"
                                                            name={questionsItem._id + 1}
                                                            value="answerA"
                                                            className="radio"
                                                            onChange={handleAnswerElected(idx)}
                                                            disabled = {
                                                                isRunning
                                                                ?
                                                                false
